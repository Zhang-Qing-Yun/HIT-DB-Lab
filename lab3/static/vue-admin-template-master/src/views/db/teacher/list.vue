<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
        <el-form-item>
            <el-input v-model="queryCondition.id" placeholder="编号/ID"/>
        </el-form-item>
        ...
        <el-button type="primary" icon="el-icon-search" @click="getAllTeachers()">查询</el-button>
    ...
    <el-pagination
      ...
      @current-change="getAllTeachers"  
    />
  </div>
</template>

<script>
import teacher from '@/api/db/teacher'
export default {
    data(){  // 定义变量和初始值
        return {
            list:null,  // 查询返回值
    ...
    methods:{  // 创建要使用的方法
        getAllTeachers(current = 1) {
            this.current = current
            teacher.getAllTeachers(this.current, this.queryCondition)
